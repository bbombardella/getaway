...
export default function useWalk(maxSteps) {
    ...
    function testCollision({ x, y }, dir) {
        ...
        if (tile === undefined) {
            ...
            setInteract(false);
            if (MAP_TILES[collisionArray[tempy - 1][tempx]].type === 'object' || MAP_TILES[collisionArray[tempy - 1][tempx]].type === 'panneau' || MAP_TILES[collisionArray[tempy - 1][tempx]].type === 'coffre' || MAP_TILES[collisionArray[tempy - 1][tempx]].type === 'fontaine' || MAP_TILES[collisionArray[tempy - 1][tempx]].type === 'miroir') {
                setInteract(true);
            ...
            if (MAP_TILES[collisionArray[tempy][tempx - 1]].type === 'object' || MAP_TILES[collisionArray[tempy][tempx - 1]].type === 'panneau' || MAP_TILES[collisionArray[tempy][tempx - 1]].type === 'coffre' || MAP_TILES[collisionArray[tempy][tempx - 1]].type === 'fontaine' || MAP_TILES[collisionArray[tempy][tempx - 1]].type === 'miroir') {
                setInteract(true);
